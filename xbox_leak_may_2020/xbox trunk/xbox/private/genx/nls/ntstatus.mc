...
FacilityNames=(System=0x0
               ...
               XBOX=0x5:FACILITY_XBOX_ERROR_CODE
...
MessageId=0x0001 Facility=XBOX Severity=Error SymbolicName=STATUS_IMAGE_GAME_REGION_VIOLATION
Language=English
The Xbox image is not allowed to run from the console's game region.
.

MessageId=0x0002 Facility=XBOX Severity=Error SymbolicName=STATUS_IMAGE_MEDIA_TYPE_VIOLATION
Language=English
