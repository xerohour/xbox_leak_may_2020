...
MessageId=0258 SymbolicName=WAIT_TIMEOUT
Language=English
...
MessageId=8504 SymbolicName=ERROR_DS_SAM_INIT_FAILURE
Language=English
...
MessageId=8524
SymbolicName=ERROR_DS_DNS_LOOKUP_FAILURE
Language=English
...
MessageId=8544
SymbolicName=ERROR_DS_DRA_EARLIER_SCHEMA_CONFLICT
Language=English
...
.
MessageId=18 Facility=Dispatch Severity=CoError
        SymbolicName=DISP_E_DIVBYZERO Language=English
Division by zero.
.
MessageId=19 Facility=Dispatch Severity=CoError
        SymbolicName=DISP_E_BUFFERTOOSMALL Language=English
Buffer too small
.
...
Buffer too small.
.
MessageId=32791 Facility=Dispatch Severity=CoError
        SymbolicName=TYPE_E_FIELDNOTFOUND Language=English
...
.
MessageId=0x0111 Facility=Storage Severity=CoError
        SymbolicName=STG_E_DOCFILETOOLARGE Language=English
The compound file is too large for the current implementation
.
MessageId=0x0112 Facility=Storage Severity=CoError
        SymbolicName=STG_E_NOTSIMPLEFORMAT Language=English
...
.
MessageId=0x0204 Facility=Storage Severity=Success
        SymbolicName=STG_S_MULTIPLEOPENS Language=English
Multiple opens prevent consolidated. (commit succeeded).
.
MessageId=0x0205 Facility=Storage Severity=Success
        SymbolicName=STG_S_CONSOLIDATIONFAILED Language=English
Consolidation of the storage file failed. (commit succeeded).
.
MessageId=0x0206 Facility=Storage Severity=Success
        SymbolicName=STG_S_CANNOTCONSOLIDATE Language=English
