...
#define SOCK_RAW        3               /* raw-protocol interface */                ;noxbox
#define SOCK_RDM        4               /* reliably-delivered message */            ;noxbox
#define SOCK_SEQPACKET  5               /* sequenced packet stream */               ;noxbox

/*
 * Option flags per-socket.
 */
#define SO_DEBUG        0x0001          /* turn on debugging info recording */      ;noxbox
#define SO_ACCEPTCONN   0x0002          /* socket has had listen() */
#define SO_REUSEADDR    0x0004          /* allow local address reuse */
#define SO_KEEPALIVE    0x0008          /* keep connections alive */                ;noxbox
#define SO_DONTROUTE    0x0010          /* just use interface addresses */          ;noxbox
#define SO_BROADCAST    0x0020          /* permit sending of broadcast msgs */
#define SO_USELOOPBACK  0x0040          /* bypass hardware when possible */         ;noxbox
#define SO_LINGER       0x0080          /* linger on close if data present */
#define SO_OOBINLINE    0x0100          /* leave received OOB data in line */       ;noxbox
...
#define SO_SNDLOWAT     0x1003          /* send low-water mark */                   ;noxbox
#define SO_RCVLOWAT     0x1004          /* receive low-water mark */                ;noxbox
#define SO_SNDTIMEO     0x1005          /* send timeout */
#define SO_RCVTIMEO     0x1006          /* receive timeout */
#define SO_ERROR        0x1007          /* get error status and clear */            ;noxbox
 ...
 */
#define AF_UNIX         1               /* local to host (pipes, portals) */        ;noxbox
