...
!MESSAGE 
!MESSAGE NMAKE /f "VideoTest.mak" CFG="VideoTest - Xbox Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "VideoTest - Xbox Release" (based on "Xbox Application")
!MESSAGE "VideoTest - Xbox Debug" (based on "Xbox Application")
!MESSAGE 
...
# ADD CPP /nologo /W3 /GX /O2 /I "..\..\Samples\Common\include" /D "WIN32" /D "_XBOX" /D "SILVER" /D "NDEBUG" /YX /FD /Zvc6 /G6 /c
BSC32=bscmake.exe
...
# ADD XBE /nologo /testid:"0xffff0000" /testname:"VideoTest" /testpubname:"Microsoft" /stack:0x10000
XBCP=xbecopy.exe
...
!ELSEIF  "$(CFG)" == "VideoTest - Xbox Debug"
...
# ADD CPP /nologo /W3 /Gm /GX /Zi /Od /I "..\..\Samples\Common\include" /D "WIN32" /D "_XBOX" /D "SILVER" /D "_DEBUG" /YX /FD /Zvc6 /G6 /c
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
LINK32=link.exe
...
# ADD XBE /nologo /testid:"0xffff0000" /testname:"VideoTest" /testpubname:"Microsoft" /stack:0x10000 /debug
XBCP=xbecopy.exe
# ADD BASE XBCP /NOLOGO
# ADD XBCP /NOLOGO
# Begin Special Build Tool
RemoteDir=xe:\samples\vt2
SOURCE="$(InputPath)"
PostBuild_Cmds=xbcp -r -y -d -t -f media\*.* $(RemoteDir)\media
# End Special Build Tool
...
# Name "VideoTest - Xbox Release"
# Name "VideoTest - Xbox Debug"
# Begin Group "Common"

# PROP Default_Filter ""
# Begin Source File

SOURCE=..\..\samples\common\src\xbapp.cpp
# End Source File
# Begin Source File

SOURCE=..\..\samples\common\src\xbfont.cpp
# End Source File
# Begin Source File

SOURCE=..\..\samples\common\src\xbhelp.cpp
# End Source File
# Begin Source File

SOURCE=..\..\samples\common\src\xbinput.cpp
# End Source File
# Begin Source File

SOURCE=..\..\samples\common\src\xbmesh.cpp
# End Source File
# Begin Source File

SOURCE=..\..\samples\common\src\XBResource.cpp
# End Source File
# Begin Source File

SOURCE=..\..\samples\common\src\xbsound.cpp
# End Source File
# Begin Source File

SOURCE=..\..\samples\common\src\xbutil.cpp
# End Source File
# End Group
# Begin Source File
