# Microsoft Developer Studio Project File - Name="VoiceLoopBack" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 60000
# ** DO NOT EDIT **

# TARGTYPE "Xbox Application" 0x0b01

CFG=VoiceLoopBack - Xbox Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "VoiceLoopBack.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "VoiceLoopBack.mak" CFG="VoiceLoopBack - Xbox Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "VoiceLoopBack - Xbox Release" (based on "Xbox Application")
!MESSAGE "VoiceLoopBack - Xbox Debug" (based on "Xbox Application")
!MESSAGE 
...
!IF  "$(CFG)" == "VoiceLoopBack - Xbox Release"
...
# ADD LINK32 xapilib.lib d3d8.lib d3dx8.lib xgraphics.lib dsound.lib dmusic.lib xboxkrnl.lib xvoice.lib /nologo /incremental:no /machine:I386 /subsystem:xbox  /opt:ref /fixed:no /debugtype:vc6
XBE=imagebld.exe
# ADD BASE XBE /nologo /stack:0x10000
# ADD XBE /nologo /testid:"0xffff0110" /testname:"VoiceLoopBack" /stack:0x10000 /INITFLAGS:0x00000000  /out:"Release/VoiceLoopBack.xbe"
XBCP=xbecopy.exe
...
!ELSEIF  "$(CFG)" == "VoiceLoopBack - Xbox Debug"
...
# ADD LINK32 xapilibd.lib d3d8d.lib d3dx8d.lib xgraphicsd.lib dsoundd.lib dmusicd.lib xboxkrnl.lib xvoiced.lib /nologo /incremental:no /debug /machine:I386 /subsystem:xbox  /fixed:no /debugtype:vc6
XBE=imagebld.exe
# ADD BASE XBE /nologo /stack:0x10000 /debug
# ADD XBE /nologo /testid:"0xffff0110" /testname:"VoiceLoopBack" /stack:0x10000 /debug /INITFLAGS:0x00000000  /out:"Debug/VoiceLoopBack.xbe"
XBCP=xbecopy.exe
# ADD BASE XBCP /NOLOGO
# ADD XBCP /NOLOGO
# Begin Special Build Tool
...
# Name "VoiceLoopBack - Xbox Release"
# Name "VoiceLoopBack - Xbox Debug"
# Begin Group "Common"
