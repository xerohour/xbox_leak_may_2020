...
!MESSAGE 
!MESSAGE NMAKE /f "FileStream.mak" CFG="FileStream - Xbox Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "FileStream - Xbox Release" (based on "Xbox Application")
!MESSAGE "FileStream - Xbox Debug" (based on "Xbox Application")
!MESSAGE 
...
!IF  "$(CFG)" == "FileStream - Xbox Release"
...
# ADD XBE /nologo /testid:"0xffff0026" /testname:"FileStream" /stack:0x10000 /INITFLAGS:0x00000000  /out:"Release/FileStream.xbe"
XBCP=xbecopy.exe
...
!ELSEIF  "$(CFG)" == "FileStream - Xbox Debug"
...
# ADD XBE /nologo /testid:"0xffff0026" /testname:"FileStream" /stack:0x10000 /debug /INITFLAGS:0x00000000  /out:"Debug/FileStream.xbe"
XBCP=xbecopy.exe
# ADD BASE XBCP /NOLOGO
# ADD XBCP /NOLOGO
# Begin Special Build Tool
...
# Name "FileStream - Xbox Release"
# Name "FileStream - Xbox Debug"
# Begin Group "Common"
