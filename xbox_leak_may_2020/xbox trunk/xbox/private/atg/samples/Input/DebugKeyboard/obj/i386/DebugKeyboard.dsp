# Microsoft Developer Studio Project File - Name="DebugKeyboard" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 60000
# ** DO NOT EDIT **

# TARGTYPE "Xbox Application" 0x0b01

CFG=DebugKeyboard - Xbox Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "DebugKeyboard.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "DebugKeyboard.mak" CFG="DebugKeyboard - Xbox Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "DebugKeyboard - Xbox Release" (based on "Xbox Application")
!MESSAGE "DebugKeyboard - Xbox Debug" (based on "Xbox Application")
!MESSAGE 
...
!IF  "$(CFG)" == "DebugKeyboard - Xbox Release"
...
# ADD LINK32 xapilib.lib d3d8.lib d3dx8.lib xgraphics.lib dsound.lib dmusic.lib xboxkrnl.lib xbdm.lib xkbd.lib /nologo /incremental:no /machine:I386 /subsystem:xbox  /opt:ref /fixed:no /debugtype:vc6
XBE=imagebld.exe
# ADD BASE XBE /nologo /stack:0x10000
# ADD XBE /nologo /testid:"0xffff05ae" /testname:"DebugKeyboard" /stack:0x10000 /INITFLAGS:0x00000000  /out:"Release/DebugKeyboard.xbe"
XBCP=xbecopy.exe
...
!ELSEIF  "$(CFG)" == "DebugKeyboard - Xbox Debug"
...
# ADD LINK32 xapilibd.lib d3d8d.lib d3dx8d.lib xgraphicsd.lib dsoundd.lib dmusicd.lib xboxkrnl.lib xbdm.lib xkbdd.lib /nologo /incremental:no /debug /machine:I386 /subsystem:xbox  /fixed:no /debugtype:vc6
XBE=imagebld.exe
# ADD BASE XBE /nologo /stack:0x10000 /debug
# ADD XBE /nologo /testid:"0xffff05ae" /testname:"DebugKeyboard" /stack:0x10000 /debug /INITFLAGS:0x00000000  /out:"Debug/DebugKeyboard.xbe"
XBCP=xbecopy.exe
# ADD BASE XBCP /NOLOGO
# ADD XBCP /NOLOGO
# Begin Special Build Tool
...
# Name "DebugKeyboard - Xbox Release"
# Name "DebugKeyboard - Xbox Debug"
# Begin Group "Common"
...
SOURCE=.\systemfont.rdf

!IF  "$(CFG)" == "DebugKeyboard - Xbox Release"

# Begin Custom Build
ProjDir=.
InputPath=.\systemfont.rdf
InputName=systemfont
