...
!MESSAGE 
!MESSAGE NMAKE /f "CreateDevice.mak" CFG="CreateDevice - Xbox Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "CreateDevice - Xbox Release" (based on "Xbox Application")
!MESSAGE "CreateDevice - Xbox Debug" (based on "Xbox Application")
!MESSAGE 
...
!IF  "$(CFG)" == "CreateDevice - Xbox Release"
...
# ADD XBE /nologo /testid:"0xffff0018" /testname:"CreateDevice" /stack:0x10000 /INITFLAGS:0x00000000  /out:"Release/CreateDevice.xbe"
XBCP=xbecopy.exe
# ADD BASE XBCP /NOLOGO
# ADD XBCP /NOLOGO


!ELSEIF  "$(CFG)" == "CreateDevice - Xbox Debug"
...
# ADD XBE /nologo /testid:"0xffff0018" /testname:"CreateDevice" /stack:0x10000 /debug /INITFLAGS:0x00000000  /out:"Debug/CreateDevice.xbe"
XBCP=xbecopy.exe
# ADD BASE XBCP /NOLOGO
# ADD XBCP /NOLOGO
...
# Name "CreateDevice - Xbox Release"
# Name "CreateDevice - Xbox Debug"
