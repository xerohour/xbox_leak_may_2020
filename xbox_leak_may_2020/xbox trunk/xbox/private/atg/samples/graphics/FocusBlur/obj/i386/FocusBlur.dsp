# Microsoft Developer Studio Project File - Name="FocusBlur" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 60000
# ** DO NOT EDIT **

# TARGTYPE "Xbox Application" 0x0b01

CFG=FocusBlur - Xbox Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "FocusBlur.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "FocusBlur.mak" CFG="FocusBlur - Xbox Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "FocusBlur - Xbox Release" (based on "Xbox Application")
!MESSAGE "FocusBlur - Xbox Debug" (based on "Xbox Application")
!MESSAGE 
...
# ADD XBE /nologo /testid:"0xffff0606" /testname:"FocusBlur" /stack:0x10000 /INITFLAGS:0x00000000  /out:"Release/FocusBlur.xbe"
XBCP=xbecopy.exe
...
!ELSEIF  "$(CFG)" == "FocusBlur - Xbox Debug"
...
# ADD XBE /nologo /testid:"0xffff0606" /testname:"FocusBlur" /stack:0x10000 /debug /INITFLAGS:0x00000000  /out:"Debug/FocusBlur.xbe"
XBCP=xbecopy.exe
# ADD BASE XBCP /NOLOGO
# ADD XBCP /NOLOGO
# Begin Special Build Tool
...
# Name "FocusBlur - Xbox Release"
# Name "FocusBlur - Xbox Debug"
# Begin Group "Common"
...
SOURCE=.\Media\Shaders\blur.psh

!IF  "$(CFG)" == "FocusBlur - Xbox Release"

# Begin Custom Build - xsasm $(InputPath)
ProjDir=.
InputPath=.\Media\Shaders\blur.psh
InputName=blur

BuildCmds= \
	if EXIST $(ProjDir)\$(InputName).inl attrib -r $(ProjDir)\$(InputName).inl \
...
SOURCE=.\Media\Shaders\depthlookup.psh

!IF  "$(CFG)" == "FocusBlur - Xbox Release"

# Begin Custom Build - xsasm $(InputPath)
ProjDir=.
InputPath=.\Media\Shaders\depthlookup.psh
InputName=depthlookup
...
SOURCE=.\Media\Shaders\depth.psh

!IF  "$(CFG)" == "FocusBlur - Xbox Release"

# Begin Custom Build - xsasm $(InputPath)
ProjDir=.
InputPath=.\Media\Shaders\depth.psh
InputName=depth
...
SOURCE=.\Media\Shaders\focus.psh

!IF  "$(CFG)" == "FocusBlur - Xbox Release"

# Begin Custom Build - xsasm $(InputPath)
ProjDir=.
InputPath=.\Media\Shaders\focus.psh
InputName=focus
...
SOURCE=.\Media\Shaders\focuslookup.psh

!IF  "$(CFG)" == "FocusBlur - Xbox Release"

# Begin Custom Build - xsasm $(InputPath)
ProjDir=.
InputPath=.\Media\Shaders\focuslookup.psh
InputName=focuslookup
