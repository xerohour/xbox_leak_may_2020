//-----------------------------------------------------------------------------
// Name: DolphinClassic Xbox Sample
// 
...
Description
===========
   The DolphinClassic sample shows an underwater scene of a dolphin swimming, 
   with caustic effects on the dolphin and seafloor. The dolphin is animated
   using a technique called "tweening". The underwater effect simply uses fog, 
   and the water caustics use an animated set of textures.
