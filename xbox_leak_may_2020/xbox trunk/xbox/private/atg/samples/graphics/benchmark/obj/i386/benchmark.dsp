...
!MESSAGE 
!MESSAGE NMAKE /f "BenchMark.mak" CFG="BenchMark - Xbox Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "BenchMark - Xbox Release" (based on "Xbox Application")
!MESSAGE "BenchMark - Xbox Debug" (based on "Xbox Application")
!MESSAGE 
...
# ADD XBE /nologo /testid:"0xffff0001" /testname:"BenchMark" /stack:0x10000 /INITFLAGS:0x00000000  /out:"Release/BenchMark.xbe"
XBCP=xbecopy.exe
...
!ELSEIF  "$(CFG)" == "BenchMark - Xbox Debug"
...
# ADD XBE /nologo /testid:"0xffff0001" /testname:"BenchMark" /stack:0x10000 /debug /INITFLAGS:0x00000000  /out:"Debug/BenchMark.xbe"
XBCP=xbecopy.exe
# ADD BASE XBCP /NOLOGO
# ADD XBCP /NOLOGO
# Begin Special Build Tool
...
# Name "BenchMark - Xbox Release"
# Name "BenchMark - Xbox Debug"
# Begin Group "Common"
