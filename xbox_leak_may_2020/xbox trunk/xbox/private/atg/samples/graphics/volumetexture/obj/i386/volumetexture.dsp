...
!MESSAGE 
!MESSAGE NMAKE /f "VolumeTexture.mak" CFG="VolumeTexture - Xbox Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "VolumeTexture - Xbox Release" (based on "Xbox Application")
!MESSAGE "VolumeTexture - Xbox Debug" (based on "Xbox Application")
!MESSAGE 
...
!IF  "$(CFG)" == "VolumeTexture - Xbox Release"
...
# ADD XBE /nologo /testid:"0xffff0031" /testname:"VolumeTexture" /stack:0x10000 /INITFLAGS:0x00000000  /out:"Release/VolumeTexture.xbe"
XBCP=xbecopy.exe
...
!ELSEIF  "$(CFG)" == "VolumeTexture - Xbox Debug"
...
# ADD XBE /nologo /testid:"0xffff0031" /testname:"VolumeTexture" /stack:0x10000 /debug /INITFLAGS:0x00000000  /out:"Debug/VolumeTexture.xbe"
XBCP=xbecopy.exe
# ADD BASE XBCP /NOLOGO
# ADD XBCP /NOLOGO
# Begin Special Build Tool
...
# Name "VolumeTexture - Xbox Release"
# Name "VolumeTexture - Xbox Debug"
# Begin Group "Common"
