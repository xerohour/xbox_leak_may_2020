========================================================================
		ActiveX Control DLL : REGIONKEYBOARD
========================================================================

ControlWizard has created this project for your REGIONKEYBOARD ActiveX Control
...
that make up your REGIONKEYBOARD ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
RegionKeyboard control:

RegionKeyboardCtl.h
	This file contains the declaration of the CRegionKeyboardCtrl C++ class.

RegionKeyboardCtl.cpp
	This file contains the implementation of the CRegionKeyboardCtrl C++ class.

RegionKeyboardPpg.h
	This file contains the declaration of the CRegionKeyboardPropPage C++ class.

RegionKeyboardPpg.cpp
	This file contains the implementation of the CRegionKeyboardPropPage C++ class.

RegionKeyboardCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CRegionKeyboardCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file RegionKeyboard.rc.
