========================================================================
		ActiveX Control DLL : KEYSOCX
========================================================================

ControlWizard has created this project for your KEYSOCX ActiveX Control
...
that make up your KEYSOCX ActiveX Control DLL.
...
KeysOCXCtl.h
	This file contains the declaration of the CKeysOCXCtrl C++ class.

KeysOCXCtl.cpp
	This file contains the implementation of the CKeysOCXCtrl C++ class.

KeysOCXPpg.h
	This file contains the declaration of the CKeysOCXPropPage C++ class.

KeysOCXPpg.cpp
	This file contains the implementation of the CKeysOCXPropPage C++ class.

KeysOCXCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CKeysOCXCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file KeysOCX.rc.
