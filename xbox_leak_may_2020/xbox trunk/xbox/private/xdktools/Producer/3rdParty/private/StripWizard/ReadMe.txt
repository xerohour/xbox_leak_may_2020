========================================================================
                    CUSTOM APPWIZARD: StripWizard
========================================================================


AppWizard has created a StripWizard DLL for you.  This DLL is the starting point
...
you build StripWizard.awx, it will automatically be copied to your Template
...
StripWizardAw.h, StripWizardAw.cpp - the CCustomAppWiz class
    These files contain your CCustomAppWiz-derived class,
    CStripWizardAppWiz.  This class contains virtual member functions which
...
Template\
    ...
    import that file as a "TEMPLATE" custom resource into StripWizard.rc.  Be
...
Template\NewProj.inf
    ...
    generated from the project "E:\source\jazz\3rdParty\samples\LyricStripMgr\LyricStripMgr.dsp".
...
off of the project "E:\source\jazz\3rdParty\samples\LyricStripMgr\LyricStripMgr.dsp".
...
StdAfx.h, StdAfx.cpp
    ...
    named StripWizard.pch and a precompiled types file named StdAfx.obj.
