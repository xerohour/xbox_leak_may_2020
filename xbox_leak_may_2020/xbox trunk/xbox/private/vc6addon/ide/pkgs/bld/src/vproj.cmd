...
// TODO: make this dynamic ie. not SHIP
COMMAND IDG_DEBUG_1 IDM_PROJECT_OPENDIALOG NOKEY NOMENU NOBUTTON 
	"" "Open Dialog"
	PROMPT "Open Dialog"

// R.I.P. perhaps v4.0
// COMMAND IDG_BUILD_SETTINGS IDM_PROJECT_TOOLS
//	"ProjectTools" "C&ustom Tools..."
//	PROMPT "Add, edit and delete custom tools"
...
// This command toggles between build and stop build. Used for the menu
...
#ifdef VB_MAKEFILES
COMMAND IDG_BUILD_1 IDM_PROJECT_EDIT NOMENU NOKEY
	"" "Visual Basic"
	PROMPT "Launches Visual Basic on this project"
#endif
...
//COMMAND IDG_PROJECTOPS_SCHM IDM_PROJECT_CLOSEBSC
//	"ProjectCloseBrowseInfo" "C&lose Browse Info" 
//	PROMPT "Closes the Browse Info File"
