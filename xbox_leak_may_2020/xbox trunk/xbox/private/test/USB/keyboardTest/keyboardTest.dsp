# Microsoft Developer Studio Project File - Name="keyboardTest" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 60000
# ** DO NOT EDIT **

# TARGTYPE "Xbox Application" 0x0b01

CFG=keyboardTest - Xbox Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "keyboardTest.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "keyboardTest.mak" CFG="keyboardTest - Xbox Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "keyboardTest - Xbox Release" (based on "Xbox Application")
!MESSAGE "keyboardTest - Xbox Debug" (based on "Xbox Application")
!MESSAGE 
...
!IF  "$(CFG)" == "keyboardTest - Xbox Release"
...
!ELSEIF  "$(CFG)" == "keyboardTest - Xbox Debug"
...
# ADD LINK32 xapilibd.lib d3d8d.lib d3dx8d.lib xgraphicsd.lib dsoundd.lib dmusicd.lib xnetd.lib xboxkrnl.lib  xkbd.lib /nologo /incremental:no /debug /machine:I386 /subsystem:xbox /fixed:no /debugtype:vc6
XBE=imagebld.exe
...
# Name "keyboardTest - Xbox Release"
# Name "keyboardTest - Xbox Debug"
