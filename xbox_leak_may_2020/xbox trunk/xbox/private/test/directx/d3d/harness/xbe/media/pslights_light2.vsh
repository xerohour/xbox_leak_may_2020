...
; Calculate the length of the vertex-light vector to get the light distance

dp3 r1, r0, r0

; Calculate the light attenuation

rsq r0, r1          ; r0 = (1/d, 1/d, 1/d, 1/d)
rcp r4, r0          ; r4 = (d, d, d, d)
mul r1, r4, r4      ; r1 = (d*d, d*d, d*d, d*d)
dst r2, r1, r0      ; r2 = (1, d, d*d, 1/d)
dp3 r3, r2, c7
rcp oD0.w, r3
;rcp r0, r3

; Clamp the light to the given range
