...
BOOL CTest::Initialize() {
    ...
    m_prVertices[0] = LVERTEX(D3DXVECTOR3(-10.0f,-10.0f, 0.0f), RGBA_MAKE(255, 255, 0, 255), 0, 0.0f, 1.0f);
    m_prVertices[1] = LVERTEX(D3DXVECTOR3(-10.0f, 10.0f, 0.0f), RGBA_MAKE(0, 0, 255, 0), 0, 0.0f, 0.0f);
    m_prVertices[2] = LVERTEX(D3DXVECTOR3( 10.0f, 10.0f, 0.0f), RGBA_MAKE(0, 255, 0, 0), 0, 1.0f, 0.0f);
    m_prVertices[3] = LVERTEX(D3DXVECTOR3( 10.0f,-10.0f, 0.0f), RGBA_MAKE(255, 0, 0, 255), 0, 1.0f, 1.0f);
