...
BOOL CTest::Initialize() {
    ...
    m_pd3dr = CreateVertexBuffer(m_pDevice, m_prBackground, 4 * sizeof(TLVERTEX),
                                    0, FVF_TLVERTEX);

    m_pd3dt[0] = (CTexture8*)CreateTexture(m_pDevice, TEXT("brick.bmp"), D3DFMT_A8R8G8B8, TTYPE_TEXTURE, NULL, 1.0f, COLORKEY_NONE, D3DPOOL_MANAGED, 256, 256);
    m_pd3dt[1] = (CTexture8*)CreateTexture(m_pDevice, TEXT("chess.bmp"), D3DFMT_A8R8G8B8, TTYPE_TEXTURE, NULL, 1.0f, COLORKEY_NONE, D3DPOOL_MANAGED, 256, 256);
    m_pd3dt[2] = (CTexture8*)CreateTexture(m_pDevice, TEXT("directx.bmp"), D3DFMT_A8R8G8B8, TTYPE_TEXTURE, NULL, 1.0f, COLORKEY_NONE, D3DPOOL_MANAGED, 128, 128);
    m_pd3dt[3] = (CTexture8*)CreateTexture(m_pDevice, TEXT("ground.bmp"), D3DFMT_A8R8G8B8, TTYPE_TEXTURE, NULL, 1.0f, COLORKEY_NONE, D3DPOOL_MANAGED, 128, 128);
...
BOOL CTest::Render() {
    ...
    for (i = 0; i < 4; i++) {
        ...
        SetColorStage(m_pDevice, i, D3DTA_TEXTURE, i > 0 ? D3DTA_CURRENT : D3DTA_DIFFUSE, D3DTOP_MODULATE);
    }

    m_pDevice->SetTextureStageState(5, D3DTSS_COLOROP, D3DTOP_MODULATE);
