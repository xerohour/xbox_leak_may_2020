...
BOOL CTest::Initialize() {
    ...
    char szShader[] = {
            "ps.1.0\n"
            "tex t0\n"
            "texm3x2pad t1, t0_sgn\n"
            "texm3x2tex t2, t0_sgn\n"
            "mov r0, t2\n"
         };
    ...
    m_prQuad[0].vR1.x = 1.0f;
    m_prQuad[0].vR1.y = 0.0f;
    m_prQuad[0].vR1.z = 0.0f;
    m_prQuad[0].vR2.x = 0.0f;
    m_prQuad[0].vR2.y = 1.0f;
    m_prQuad[0].vR2.z = 0.0f;
    memcpy(&m_prQuad[1].vR1, &m_prQuad[0].vR1, 2 * sizeof(D3DXVECTOR3));
    memcpy(&m_prQuad[2].vR1, &m_prQuad[0].vR1, 2 * sizeof(D3DXVECTOR3));
    memcpy(&m_prQuad[3].vR1, &m_prQuad[0].vR1, 2 * sizeof(D3DXVECTOR3));
...
BOOL CTest::Render() {
    ...
    m_pDevice->SetTexture(2, m_pd3dt2);
