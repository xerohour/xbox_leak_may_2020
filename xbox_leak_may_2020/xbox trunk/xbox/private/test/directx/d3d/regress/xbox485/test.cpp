...
BOOL CTest::Initialize() {
    ...
    m_prTriangle[0] = TLVERTEX(D3DXVECTOR3(fWidth / 2.0f, 0.0f, 0.9999f), 0.01f, RGBA_MAKE(0,0,128,255), RGB_MAKE(0,0,0), 0.0f, 1.0f);
    m_prTriangle[1] = TLVERTEX(D3DXVECTOR3(fWidth, fHeight, 0.9999f), 0.01f, RGBA_MAKE(0,0,255,255), RGB_MAKE(0,0,0), 0.0f, 0.0f);
    m_prTriangle[2] = TLVERTEX(D3DXVECTOR3(0.0f, fHeight, 0.9999f), 0.01f, RGBA_MAKE(0,0,255,255), RGB_MAKE(0,0,0), 1.0f, 0.0f);
...
//    m_pDevice->DrawPrimitive(D3DPT_TRIANGLELIST, 0, 1);
    m_pDevice->DrawPrimitiveUP(D3DPT_TRIANGLELIST, 1, m_prTriangle, sizeof(TLVERTEX));
