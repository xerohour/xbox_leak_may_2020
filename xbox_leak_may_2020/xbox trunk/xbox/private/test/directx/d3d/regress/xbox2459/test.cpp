...
BOOL CReproTest::Create(HINSTANCE hInstance) {
    ...
    LPDIRECT3DSURFACE8      pd3dsT, pd3dsZ;
    ...
    m_pDevice->CreateTexture(256, 256, 1, D3DUSAGE_RENDERTARGET, D3DFMT_A8R8G8B8, D3DPOOL_DEFAULT, &pd3dt);

    m_pDevice->CreateDepthStencilSurface(256, 256, D3DFMT_LIN_D16, D3DMULTISAMPLE_NONE, &pd3dsZ);

    pd3dt->GetSurfaceLevel(0, &pd3dsT);

    m_pDevice->SetRenderTarget(pd3dsT, pd3dsZ);
