...
BOOL CReproTest::Create(HINSTANCE hInstance) {
    ...
    d3dpp.MultiSampleType                   = D3DMULTISAMPLE_2_SAMPLES_SUPERSAMPLE_VERTICAL_LINEAR;
    ...
    plrVertices[0] = LVERTEX(D3DXVECTOR3(-10.0f, -10.0f, 0.0f), RGBA_MAKE(255, 255, 255, 255), 0, 0.0f, 0.0f);
    plrVertices[1] = LVERTEX(D3DXVECTOR3( 0.0f,  10.0f, 0.0f), RGBA_MAKE(255, 255, 255, 255), 0, 0.0f, 0.0f);
    plrVertices[2] = LVERTEX(D3DXVECTOR3( 10.0f, -10.0f, 0.0f), RGBA_MAKE(255, 255, 255, 255), 0, 0.0f, 0.0f);
...
BOOL CReproTest::Run() {
    ...
    do {
        ...
        if (PeekMessage(&msg, NULL, 0, 0, PM_REMOVE)) {
            ...
            m_pDevice->SetRenderState(D3DRS_COLORWRITEENABLE, D3DCOLORWRITEENABLE_BLUE);
