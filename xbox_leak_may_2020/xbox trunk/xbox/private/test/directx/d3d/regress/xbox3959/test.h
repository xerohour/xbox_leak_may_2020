...
#define FVF_VERTEXDP3   (D3DFVF_XYZ | D3DFVF_NORMAL | D3DFVF_TEX3 | D3DFVF_TEXCOORDSIZE3(0) | D3DFVF_TEXCOORDSIZE3(1) | D3DFVF_TEXCOORDSIZE3(2))
...
typedef struct _VERTEXDP3 {
    ...
    _VERTEXDP3(const D3DVECTOR& v, const D3DVECTOR& n, float _u0, float _v0, float _t0) { 
        ...
        vR1.x = 0.0f; vR1.y = 0.0f; vR1.z = 0.0f;
        vR2.x = 0.0f; vR2.y = 0.0f; vR2.z = 0.0f;
    }
