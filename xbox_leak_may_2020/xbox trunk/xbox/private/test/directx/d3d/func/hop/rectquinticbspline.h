...
Module Name:
	...
	rectquinticbspline.h

Abstract:

	Data structures for Quintic B-Spline surface patches
...
#ifndef __RECTQUINTICBSPLINE_h__
#define __RECTQUINTICBSPLINE_h__
...
//	Patch Information:
//------------------------------------------------------------------------------
static D3DRECTPATCH_INFO RectQuinticBSplineInfo[] = {
	{ 0, 0, 6, 7, 6, D3DBASIS_BSPLINE, D3DORDER_QUINTIC },
};
static float RectQuinticBSplineNumSegments[][4] = {
...
//	Patch Vertices:
//------------------------------------------------------------------------------
static HopVertex RectQuinticBSplineVertices[] = {
...
//------------------------------------------------------------------------------
static HopColorVertex RectQuinticBSplineFrameVertices[] = {
...
//	Frame Indices:
//------------------------------------------------------------------------------
static WORD RectQuinticBSplineFrameIndices[] = {
	0, 1, 1, 2, 2, 3, 3, 4, 4, 5,
...
//	Number of Patches:
//------------------------------------------------------------------------------
static UINT RectQuinticBSplineNumVertices	= sizeof(RectQuinticBSplineVertices) / sizeof(HopVertex);
static UINT RectQuinticBSplineNumIndices	= sizeof(RectQuinticBSplineFrameIndices) / sizeof(WORD);
static UINT RectQuinticBSplineNumPatches	= 1;
static UINT RectQuinticBSplineNumLines		= RectQuinticBSplineNumIndices / 2;
