...
bool Clipping::ResolveTestNumber()
{
...
bool Clipping::SetWorldMatrix(void) {
	double		dRotation;
	float		cosine, sine;
	D3DMATRIX	Matrix;
...
bool Clipping::SetProjectionMatrix(void) {
	D3DMATRIX	Matrix;
	float		fZn=0.5f;
	float		fZf=1.5f;
...
bool Clipping::SetVertices(void) {
	DWORD	i;
...
bool Clipping::SetProperties(void) 
{
...
bool Clipping::SetUserClipPlanes(void)
{
#ifndef UNDER_XBOX
#ifdef TESTTYPE_UCLIP
    D3DMATRIX           Matrix;
