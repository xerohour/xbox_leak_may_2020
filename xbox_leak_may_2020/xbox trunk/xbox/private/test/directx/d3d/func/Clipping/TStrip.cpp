...
bool TStrip::TestTerminate(void)
{
    if (m_pInputVertices)
    {
        delete [] m_pInputVertices;
...
bool TStrip::GenerateTriangleStrip(void) {
	int		iSegments = 30;
	int		iCount;
	float	fX;
	float	fY;
...
bool TStrip::SetWorldMatrix(void) {
	D3DMATRIX	Matrix;
