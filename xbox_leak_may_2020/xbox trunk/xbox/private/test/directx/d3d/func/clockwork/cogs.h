...
typedef struct _COG {
    DWORD                       dwSides;
    PVERTEX                     prCenter;
    CVertexBuffer8*             pd3drCenter;
    DWORD                       dwCenterVertices;
    LPWORD                      pwCenter;
    DWORD                       dwCenterIndices;
    CIndexBuffer8*              pd3diCenter;
    PVERTEX*                    pprTeeth;
    CVertexBuffer8*             pd3drTeeth;
...
typedef struct _CLOCKWORK {
    ...
    CIndexBuffer8*              pd3diShaft;
    CIndexBuffer8*              pd3diTooth;

    PGEAR                       pgearRoot;

    CTexture8*                  pd3dtCog[NUM_COG_TEXTURES];
    CTexture8*                  pd3dtShaft[NUM_SHAFT_TEXTURES];
