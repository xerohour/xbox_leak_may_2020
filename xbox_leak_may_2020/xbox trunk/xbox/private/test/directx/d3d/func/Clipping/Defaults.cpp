...
bool Clipping::SetDefaultMatrices(void) {
    D3DMATRIX           Matrix;
...
bool Clipping::SetDefaultMaterials(void) {
...
bool Clipping::SetDefaultLights(void) {
    D3DLIGHT8   Light;
    HRESULT     hr;
