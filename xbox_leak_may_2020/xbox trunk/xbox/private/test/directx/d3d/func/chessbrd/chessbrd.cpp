...
BOOL CChessboard::Initialize() {
    ...
    // Create the textures
    m_pd3dtBoardSurface = (CTexture8*)CreateTexture(m_pDevice, TEXT("chess.bmp"), D3DFMT_A8R8G8B8, TTYPE_TEXTURE, NULL, 1.0f, COLORKEY_NONE, D3DPOOL_MANAGED, 256, 256);
    if (!m_pd3dtBoardSurface) {
        return FALSE;
    }
    m_pd3dtBoardEdge = (CTexture8*)CreateTexture(m_pDevice, TEXT("edge.bmp"), D3DFMT_A8R8G8B8, TTYPE_TEXTURE, NULL, 1.0f, COLORKEY_NONE, D3DPOOL_MANAGED, 128, 128);
    if (!m_pd3dtBoardEdge) {
        return FALSE;
    }
    m_pd3dtPawn = (CTexture8*)CreateTexture(m_pDevice, TEXT("pine.bmp"), D3DFMT_A8R8G8B8, TTYPE_TEXTURE, NULL, 1.0f, COLORKEY_NONE, D3DPOOL_MANAGED, 128, 128);
    if (!m_pd3dtPawn) {
        return FALSE;
    }
    m_pd3dtFallen = (CTexture8*)CreateTexture(m_pDevice, TEXT("pine2.bmp"), D3DFMT_A8R8G8B8, TTYPE_TEXTURE, NULL, 1.0f, COLORKEY_NONE, D3DPOOL_MANAGED, 128, 128);
    if (!m_pd3dtFallen) {
        return FALSE;
    }
#ifdef UNDER_XBOX
...
void CChessboard::Update() {
    ...
    float fDelta = m_fTimeDelta / 0.015f;
