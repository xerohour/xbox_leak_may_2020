...
//******************************************************************************
void EnvironmentMap(CDevice8* pDevice, PVERTEX prVertices, UINT uNumVertices) {
...
//    pd3dm = CreateMaterial(g_pd3dDevice, &hMaterial, RGB_MAKE(196, 196, 196), RGB_MAKE(128, 128, 128), RGB_MAKE(255, 255, 255), 0, 20.0f);
    ...
    m_pd3dt = (CTexture8*)CreateTexture(m_pDevice, TEXT("backgrnd.bmp"), D3DFMT_A8R8G8B8, TTYPE_TEXTURE, NULL, 1.0f, COLORKEY_NONE, D3DPOOL_MANAGED, 256, 256);
    if (!m_pd3dt) {
        return FALSE;
    }
