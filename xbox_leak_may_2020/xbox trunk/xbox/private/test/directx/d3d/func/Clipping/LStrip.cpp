...
bool LStrip::TestTerminate(void)
{
    if (m_pInputVertices)
    {
        delete [] m_pInputVertices;
...
bool LStrip::GenerateLineStrip(void) {
	int		iSegments = 30;
	int		iCount;
	float	fX;
	float	fY;
...
bool LStrip::SetWorldMatrix(void) {
	D3DMATRIX	Matrix;
