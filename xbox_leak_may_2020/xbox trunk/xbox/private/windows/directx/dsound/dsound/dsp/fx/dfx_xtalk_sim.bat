...
asm56300 -DSIM '1' -DSTEREO '1' -DFX_START_ROUTINE 'StartCTC' -DFX_FILENAME 'xtalk.asm' -DFX_TEST '1' -a -g -q -I ..\Include -BObj\defaultEngine.cld defaultEngine.asm > Obj\errDefaultEngine.txt
