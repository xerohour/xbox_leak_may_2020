...
asm56300  -DSTANDALONE '1' -q -I ..\Include -BObj\reverb.cld reverb_wrapper.asm > Obj\errReverb.txt
...
del %_NT386TREE%\dsp\reverb.scr
xcodescr 12345678 obj\reverb.bin %_NT386TREE%\dsp\reverb.scr
xcodescr 12345678 obj\reverb.bin ..\bin\reverb.scr
