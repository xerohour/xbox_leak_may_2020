...
asm56300 -DFX_START_ROUTINE 'StartDistortion' -DFX_FILENAME 'distortion.asm' -DFX_TEST '1' -a -g -q -I ..\Include -BObj\defaultEngine.cld defaultEngine.asm > Obj\errDefaultEngine.txt
