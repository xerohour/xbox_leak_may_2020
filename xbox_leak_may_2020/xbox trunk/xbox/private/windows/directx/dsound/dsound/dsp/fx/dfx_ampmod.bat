...
asm56300 -DIO_2IN_1OUT '1' -DFX_START_ROUTINE 'StartAmpMod' -DFX_FILENAME 'ampmod.asm' -DFX_TEST '1' -a -g -q -I ..\Include -BObj\defaultEngine.cld defaultEngine.asm > Obj\errDefaultEngine.txt
