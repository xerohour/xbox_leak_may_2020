...
asm56300 -DHALFSAMPLERATE '1' -DSTEREO '1' -DIO_2IN_4OUT '1' -DFX_START_ROUTINE 'StartReverb' -DFX_FILENAME 'reverb_wrapper.asm' -DFX_TEST_REVERB '1' -DFX_TEST '1' -a -g -q -I ..\Include -BObj\defaultEngine.cld defaultEngine.asm > Obj\errDefaultEngine.txt
