...
asm56300 -DSIM '1' -DFX_START_ROUTINE 'StartCompressor' -DFX_FILENAME 'compressor.asm' -DFX_TEST '1' -a -g -q -I ..\Include -BObj\defaultEngine.cld defaultEngine.asm > Obj\errDefaultEngine.txt
