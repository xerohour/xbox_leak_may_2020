...
asm56300 -DSIM '1' -DFX_START_ROUTINE 'StartIIR2' -DFX_FILENAME 'iir2.asm' -DFX_TEST '1' -a -g -q -I ..\Include -BObj\defaultEngine.cld defaultEngine.asm > Obj\errDefaultEngine.txt
