	...
	CPerformance *pPerformance)
{
    ...
    if (m_rtLoopEnd)
    {
        ...
        // 
        // clock time looping code mis-uses m_dwRepeats since with dwRepeats=1
        // it will not repeat at all
        // adding one to repeats fixes this.
        // this is much smaller chance of regression than fixing the Play code
        //
...
HRESULT CSegState::Play( MUSIC_TIME mtAmount )
{
    ...
    if (m_rtLength)
    {
        ...
        MUSIC_TIME mtOldEndTime = m_mtEndTime;
