...
# Usage:
#
# nmake /f eds.mk [all]             Build the DLL
# nmake /f eds.mk ssync             Ssync the files needed to build this DLL
# nmake /f eds.mk slmout            Check out the files that are built by this makefile
# nmake /f eds.mk slmin             Check in the files that are built by this makefile
# nmake /f eds.mk clean             Clean the project
# nmake /f eds.mk auto.dep			Generate dependencies file (auto.dep)
#
#
...
OBJDIR=WinRel
TARGET=eds
!message Editors: working around Olympus bug 4091 by throwing -Od instead of -O2
...
# ---------------------------------------------
CPP_FLAGS=$(CPP_FLAGS) -nologo -W3 -GR -GX -DWIN32 -D_WINDOWS -D_AFXDLL -D_MBCS -D_AFXEXT -DEXPORT_EDITORS -Fp$(OBJDIR)\$(TARGET).pch -Fo$(OBJDIR)^\ -Fd$(OBJDIR)\$(TARGET).pdb -c
...
RC_FLAGS=/l 0x409 /fo$(OBJDIR)\eds.res /dNDEBUG /d_AFXDLL
...
dependencies:
!if "$(DEPEND)" == "1"
	@echo Editors: building dependencies...
# Shell DLL
	@cd $(CAFE_SHL)
...
ssync.depend:
!if "$(DEPEND)" == "1"
	@echo Editors: ssynching dependencies...
	@cd $(CAFE_SHL)
...
slmout.depend:
!if "$(DEPEND)" == "1"
	@echo Editors: checking out dependencies...
	@cd $(CAFE_SHL)
...
slmin.depend:
!if "$(DEPEND)" == "1"
	@echo Editors: checking in dependencies...
	@cd $(CAFE_SHL)
...
clean.depend:
!if "$(DEPEND)" == "1"
	@echo Editors: cleaning dependencies...
	@cd $(CAFE_SHL)
...
auto.dep.depend: nul
!if "$(DEPEND)" == "1"
	@echo Editors: Updating dependency files...
# Shl
	@cd $(CAFE_SHL)
