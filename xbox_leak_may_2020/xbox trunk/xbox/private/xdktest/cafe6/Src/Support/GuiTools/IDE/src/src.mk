...
# Usage:
#
# nmake /f src.mk [all]             Build the DLL
# nmake /f src.mk ssync             Ssync the files needed to build this DLL
# nmake /f src.mk slmout            Check out the files that are built by this makefile
# nmake /f src.mk slmin             Check in the files that are built by this makefile
# nmake /f src.mk clean             Clean the project
# nmake /f src.mk auto.dep			Generate dependencies file (auto.dep)
#
#
...
OBJDIR=WinRel
TARGET=src
!message Src: working around Olympus bug 4091 by throwing -Od instead of -O2
...
# ---------------------------------------------
CPP_FLAGS=$(CPP_FLAGS) -nologo -W3 -GR -GX -DWIN32 -D_WINDOWS -D_AFXDLL -D_MBCS -D_AFXEXT -DEXPORT_SRC -Fp$(OBJDIR)\$(TARGET).pch -Fo$(OBJDIR)^\ -Fd$(OBJDIR)\$(TARGET).pdb -c
...
RC_FLAGS=/l 0x409 /fo$(OBJDIR)\src.res /dNDEBUG /d_AFXDLL
...
dependencies:
!if "$(DEPEND)" == "1"
	@echo Src: building dependencies...
# Shell DLL
	@cd $(CAFE_SHL)
...
ssync.depend:
!if "$(DEPEND)" == "1"
	@echo Src: ssynching dependencies...
	@cd $(CAFE_SHL)
...
slmout.depend:
!if "$(DEPEND)" == "1"
	@echo Src: checking out dependencies...
	@cd $(CAFE_SHL)
...
slmin.depend:
!if "$(DEPEND)" == "1"
	@echo Src: checking in dependencies...
	@cd $(CAFE_SHL)
...
clean.depend:
!if "$(DEPEND)" == "1"
	@echo Src: cleaning dependencies...
	@cd $(CAFE_SHL)
...
auto.dep.depend: nul
!if "$(DEPEND)" == "1"
	@echo Src: Updating dependency files...
# Shl
	@cd $(CAFE_SHL)
