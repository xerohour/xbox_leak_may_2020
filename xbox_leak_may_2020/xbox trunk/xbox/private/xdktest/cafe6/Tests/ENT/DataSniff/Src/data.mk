...
# Usage:
#
# nmake /f data.mk [all]             Build the DLL
# nmake /f data.mk ssync             Ssync the files needed to build this DLL
# nmake /f data.mk slmout            Check out the files that are built by this makefile
# nmake /f data.mk slmin             Check in the files that are built by this makefile
# nmake /f data.mk clean             Clean the project
#
#
...
RC_FLAGS=/l 0x409 /fo$(OBJDIR)\data.res /dNDEBUG /d_AFXDLL
...
dependencies:
!if "$(DEPEND)" == "1"
	@echo Data: building dependencies...
# SubSuite LIB
	@cd $(CAFE_SUBSUITE)
...
ssync.depend:
!if "$(DEPEND)" == "1"
	@echo Data: ssynching dependencies...
# SubSuite LIB
	@cd $(CAFE_SUBSUITE)
...
slmout.depend:
!if "$(DEPEND)" == "1"
	@echo Data: checking out dependencies...
	@cd $(CAFE_SUBSUITE)
...
slmin.depend:
!if "$(DEPEND)" == "1"
	@echo Data: checking in dependencies...
	@cd $(CAFE_SUBSUITE)
...
clean.depend:
!if "$(DEPEND)" == "1"
	@echo Data: cleaning dependencies...
	@cd $(CAFE_SUBSUITE)
