...
# nmake /f wizards.mk ssync         Ssync the files needed to build this DLL
# nmake /f wizards.mk slmout        Check out the files that are built by this makefile
# nmake /f wizards.mk slmin         Check in the files that are built by this makefile
...
RC_FLAGS=/l 0x409 /fo$(OBJDIR)\wizards.res /dNDEBUG /d_AFXDLL
...
dependencies:
!if "$(DEPEND)" == "1"
	@echo Wizards: building dependencies...
# SubSuite LIB
	@cd $(CAFE_SUBSUITE)
...
$(OBJDIR)\wizards.res:            \
	...
	@echo Wizards test: compiling resources...
	@$(RC) $(RC_FLAGS) wizards.rc
# ---------------------------------------------
...
ssync.depend:
!if "$(DEPEND)" == "1"
	@echo Wizards: ssynching dependencies...
# SubSuite LIB
	@cd $(CAFE_SUBSUITE)
...
slmout.depend:
!if "$(DEPEND)" == "1"
	@echo Wizards: checking out dependencies...
	@cd $(CAFE_SUBSUITE)
...
slmin.depend:
!if "$(DEPEND)" == "1"
	@echo Wizards: checking in dependencies...
	@cd $(CAFE_SUBSUITE)
...
clean.depend:
!if "$(DEPEND)" == "1"
	@echo Wizards: cleaning dependencies...
	@cd $(CAFE_SUBSUITE)
