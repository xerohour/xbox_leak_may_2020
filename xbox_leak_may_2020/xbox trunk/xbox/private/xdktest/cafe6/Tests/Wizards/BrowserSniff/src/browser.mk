...
# Usage:
#
# nmake /f browser.mk [all]         Build the DLL
# nmake /f browser.mk ssync         Ssync the files needed to build this DLL
# nmake /f browser.mk slmout        Check out the files that are built by this makefile
# nmake /f browser.mk slmin         Check in the files that are built by this makefile
# nmake /f browser.mk clean         Clean the project
#
#
...
RC_FLAGS=/l 0x409 /fo$(OBJDIR)\browser.res /dNDEBUG /d_AFXDLL
...
dependencies:
!if "$(DEPEND)" == "1"
	@echo Browser: building dependencies...
# SubSuite LIB
	@cd $(CAFE_SUBSUITE)
...
ssync.depend:
!if "$(DEPEND)" == "1"
	@echo Browser: ssynching dependencies...
# SubSuite LIB
	@cd $(CAFE_SUBSUITE)
...
slmout.depend:
!if "$(DEPEND)" == "1"
	@echo Browser: checking out dependencies...
	@cd $(CAFE_SUBSUITE)
...
slmin.depend:
!if "$(DEPEND)" == "1"
	@echo Browser: checking in dependencies...
	@cd $(CAFE_SUBSUITE)
...
clean.depend:
!if "$(DEPEND)" == "1"
	@echo Browser: cleaning dependencies...
	@cd $(CAFE_SUBSUITE)
