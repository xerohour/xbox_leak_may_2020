...
# Usage:
#
# nmake /f vshell.mk [all]          Build the DLL
# nmake /f vshell.mk ssync          Ssync the files needed to build this DLL
# nmake /f vshell.mk slmout         Check out the files that are built by this makefile
# nmake /f vshell.mk slmin          Check in the files that are built by this makefile
# nmake /f vshell.mk clean          Clean the project
#
#
...
RC_FLAGS=/l 0x409 /fo$(OBJDIR)\vshell.res /dNDEBUG /d_AFXDLL
...
dependencies:
!if "$(DEPEND)" == "1"
	@echo VShell: building dependencies...
# SubSuite LIB
	@cd $(CAFE_SUBSUITE)
...
ssync.depend:
!if "$(DEPEND)" == "1"
	@echo VShell: ssynching dependencies...
# SubSuite LIB
	@cd $(CAFE_SUBSUITE)
...
slmout.depend:
!if "$(DEPEND)" == "1"
	@echo VShell: checking out dependencies...
	@cd $(CAFE_SUBSUITE)
...
slmin.depend:
!if "$(DEPEND)" == "1"
	@echo VShell: checking in dependencies...
	@cd $(CAFE_SUBSUITE)
...
clean.depend:
!if "$(DEPEND)" == "1"
	@echo VShell: cleaning dependencies...
	@cd $(CAFE_SUBSUITE)
