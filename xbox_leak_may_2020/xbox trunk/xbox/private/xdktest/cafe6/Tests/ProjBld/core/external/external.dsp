...
# PROP Scc_ProjName ""$/idetest/proj_bld/core/external", MEHAAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
MTL=midl.exe
RSC=rc.exe
...
# ADD LINK32 /nologo /subsystem:windows /dll /debug /machine:I386 /out:"..\bin/external.dll" /libpath:"..\..\..\..\lib"
...
# ADD LINK32 /nologo /subsystem:windows /dll /debug /machine:I386 /out:"..\bin/externald.dll" /pdbtype:sept /libpath:"..\..\..\..\lib"
