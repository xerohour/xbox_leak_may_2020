...
# Usage:
#
# nmake /f editgo.mk [all]          Build the DLL
# nmake /f editgo.mk ssync          Ssync the files needed to build this DLL
# nmake /f editgo.mk slmout         Check out the files that are built by this makefile
# nmake /f editgo.mk slmin          Check in the files that are built by this makefile
# nmake /f editgo.mk clean          Clean the project
#
#
...
# LEGO=	[ 0* | 1 ]				Build with for LEGO run (minimal sniff)
...
!endif
!ifndef LEGO
!message LEGO not defined; defaulting to LEGO=0
LEGO=0
!endif
!ifndef DEPEND
...
# ---------------------------------------------
# set up LEGO defines (build minimal sniff)
# ---------------------------------------------
!if "$(LEGO)" == "0"
!else
CPP_FLAGS=$(CPP_FLAGS) -DLEGO
!endif
...
RC_FLAGS=/l 0x409 /fo$(OBJDIR)\editgo.res /dNDEBUG /d_AFXDLL
...
dependencies:
!if "$(DEPEND)" == "1"
	@echo EditGo: building dependencies...
# SubSuite LIB
	@cd $(CAFE_SUBSUITE)
...
ssync.depend:
!if "$(DEPEND)" == "1"
	@echo EditGo: ssynching dependencies...
# SubSuite LIB
	@cd $(CAFE_SUBSUITE)
...
slmout.depend:
!if "$(DEPEND)" == "1"
	@echo EditGo: checking out dependencies...
	@cd $(CAFE_SUBSUITE)
...
slmin.depend:
!if "$(DEPEND)" == "1"
	@echo EditGo: checking in dependencies...
	@cd $(CAFE_SUBSUITE)
...
clean.depend:
!if "$(DEPEND)" == "1"
	@echo EditGo: cleaning dependencies...
	@cd $(CAFE_SUBSUITE)
