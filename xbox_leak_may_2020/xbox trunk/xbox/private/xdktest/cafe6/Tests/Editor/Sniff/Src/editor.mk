...
# Usage:
#
# nmake /f editor.mk [all]          Build the DLL
# nmake /f editor.mk ssync          Ssync the files needed to build this DLL
# nmake /f editor.mk slmout         Check out the files that are built by this makefile
# nmake /f editor.mk slmin          Check in the files that are built by this makefile
# nmake /f editor.mk clean          Clean the project
#
#
...
RC_FLAGS=/l 0x409 /fo$(OBJDIR)\editor.res /dNDEBUG /d_AFXDLL
...
dependencies:
!if "$(DEPEND)" == "1"
	@echo Editor: building dependencies...
# SubSuite LIB
	@cd $(CAFE_SUBSUITE)
...
$(OBJDIR)\editor.res:          \
    ed_usa.rc                  \
	resource.h                 
    @echo EDITOR SNIFF: compiling resources...
	@$(RC) $(RC_FLAGS) ed_usa.rc
...
ssync.depend:
!if "$(DEPEND)" == "1"
	@echo Editor: ssynching dependencies...
# SubSuite LIB
	@cd $(CAFE_SUBSUITE)
...
slmout.depend:
!if "$(DEPEND)" == "1"
	@echo Editor: checking out dependencies...
	@cd $(CAFE_SUBSUITE)
...
slmin.depend:
!if "$(DEPEND)" == "1"
	@echo Editor: checking in dependencies...
	@cd $(CAFE_SUBSUITE)
...
clean.depend:
!if "$(DEPEND)" == "1"
	@echo Editor: cleaning dependencies...
	@cd $(CAFE_SUBSUITE)
