...
# Usage:
#
# nmake /f sys.mk [all]             Build the DLL
# nmake /f sys.mk ssync             Ssync the files needed to build this DLL
# nmake /f sys.mk slmout            Check out the files that are built by this makefile
# nmake /f sys.mk slmin             Check in the files that are built by this makefile
# nmake /f sys.mk clean             Clean the project
#
#
...
RC_FLAGS=/l 0x409 /fo$(OBJDIR)\sys.res /dNDEBUG /d_AFXDLL
...
dependencies:
!if "$(DEPEND)" == "1"
	@echo Sys: building dependencies...
# SubSuite LIB
	@cd $(CAFE_SUBSUITE)
...
ssync.depend:
!if "$(DEPEND)" == "1"
	@echo Sys: ssynching dependencies...
# SubSuite LIB
	@cd $(CAFE_SUBSUITE)
...
slmout.depend:
!if "$(DEPEND)" == "1"
	@echo Sys: checking out dependencies...
	@cd $(CAFE_SUBSUITE)
...
slmin.depend:
!if "$(DEPEND)" == "1"
	@echo Sys: checking in dependencies...
	@cd $(CAFE_SUBSUITE)
...
clean.depend:
!if "$(DEPEND)" == "1"
	@echo Sys: cleaning dependencies...
	@cd $(CAFE_SUBSUITE)
