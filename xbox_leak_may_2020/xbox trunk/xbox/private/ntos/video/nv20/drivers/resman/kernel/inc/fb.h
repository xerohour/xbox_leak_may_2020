...
RM_STATUS fbClearInstMem(PHWINFO);
...
RM_STATUS fbLoadOverrides(PHWINFO);

RM_STATUS fbKDATakeBufferSemaphore(PHWINFO, U032);
RM_STATUS fbKDAReleaseBufferSemaphore(PHWINFO);
RM_STATUS fbKDATakeCursorCellSemaphore(PHWINFO, U032, U032);
RM_STATUS fbKDAReleaseCursorCellSemaphore(PHWINFO, U032);
RM_STATUS fbKDAFindCursorCellOffset(PHWINFO, U032, U032*);
