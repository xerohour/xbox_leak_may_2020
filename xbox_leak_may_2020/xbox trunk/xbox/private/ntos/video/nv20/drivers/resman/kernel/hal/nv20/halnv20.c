...
ENGINEDESCRIPTOR NV20_EngineDescriptors[] =
{
    ...
    MKENGMALLOC(FB_ENGINE_TAG, ENGMALLOC_TYPE_LOAD, 0xA0000/4),
...
#define NV20_ARCHITECTURE_CLASS_DESCRIPTORS                                                         \
    ...
    MKCLASSDECL(DAC_ENGINE_TAG, 0, NV20_VIDEO_LUT_CURSOR_DAC),                                      \
                                                                                                    \
