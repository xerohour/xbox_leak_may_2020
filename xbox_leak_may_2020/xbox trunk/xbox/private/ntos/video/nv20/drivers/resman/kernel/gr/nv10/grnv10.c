...
// statics
static RM_STATUS _nvHalGrInitObjectContext_NV10(PHALHWINFO, U032, U032, U032);
...
nvHalGrControl_NV10(VOID *arg)
{
    ...
    GR_PRINTF((DBG_LEVEL_INFO, "NVRM: nvHalGrControl_NV10\r\n"));
    ...
    switch (pGrControlArg->cmd)
    {
        case GR_CONTROL_INIT:
            ...
            switch (REG_RD_DRF(_PMC, _BOOT_0, _MAJOR_REVISION))
            {
                ...
                default:
                    ...
                    if (IsNV15_NV10(pHalHwInfo->pMcHalInfo) ||
                        ...
                        IsNV1A_NV10(pHalHwInfo->pMcHalInfo))
            ...
            //
            if (IsNV11_NV10(pHalHwInfo->pMcHalInfo) || IsNV1A_NV10(pHalHwInfo->pMcHalInfo)) {
...
nvHalGrAlloc_NV10(VOID *arg)
{
    ...
    GR_PRINTF((DBG_LEVEL_INFO, "NVRM: nvHalGrAlloc_NV10\r\n"));
        ...
        (pGrAllocArg->classNum == NV11_CELSIUS_PRIMITIVE))
    {
        ...
        {
            GR_PRINTF((DBG_LEVEL_INFO, "NVRM: 3d state in use by celsius instance: 0x%x\n", pGrHalPvtInfo->currentObjects3d[pGrAllocArg->chid]));
        ...
        {
            GR_PRINTF((DBG_LEVEL_INFO, "NVRM: 3d state in use by DX instance: 0x%x\n", pGrHalPvtInfo->currentObjects3d[pGrAllocArg->chid]));
            return (RM_ERR_ILLEGAL_OBJECT);
        }
    ...
    // Initialize context.
    //
    _nvHalGrInitObjectContext_NV10(pHalHwInfo, pGrAllocArg->instance, pGrAllocArg->classNum, pGrAllocArg->flags);
...
nvHalGrService_NV10(VOID *arg)
{
    ...
    {
        GR_PRINTF((DBG_LEVEL_ERRORS, "SingleStep method: 0x%x\n", REG_RD32(NV_PGRAPH_TRAPPED_ADDR)));
        GR_PRINTF((DBG_LEVEL_ERRORS, "SingleStep data  : 0x%x\n", REG_RD32(NV_PGRAPH_TRAPPED_DATA_LOW)));
...
nvHalGrGetNotifyData_NV10(VOID *arg)
{
    ...
    GR_PRINTF((DBG_LEVEL_INFO, "NVRM: nvHalGrGetNotifyData_NV10\r\n"));
...
nvHalGrSetObjectContext_NV10(VOID *arg)
{
    ...
    GR_PRINTF((DBG_LEVEL_INFO, "NVRM: nvHalGrSetObjectContext_NV10\r\n"));
...
)
{
    ...
    //
    GR_PRINTF((DBG_LEVEL_INFO, "NVRM: instance data for classNum: 0x%x\n", classNum));
    GR_PRINTF((DBG_LEVEL_INFO, "      instance offset: 0x%x\n", instance));
    GR_PRINTF((DBG_LEVEL_INFO, "      ctx1: 0x%x\n", ctx1));
    GR_PRINTF((DBG_LEVEL_INFO, "      ctx2: 0x%x\n", ctx2));
    GR_PRINTF((DBG_LEVEL_INFO, "      ctx3: 0x%x\n", ctx3));
