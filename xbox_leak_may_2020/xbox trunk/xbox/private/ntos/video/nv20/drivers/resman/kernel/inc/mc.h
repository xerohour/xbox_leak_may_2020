...
#define MC_IMPLEMENTATION_NV1A          0x0A
...
V032      busService(PHWINFO);
RM_STATUS mcPowerStateTrigger(PHWINFO);
RM_STATUS mcSetPowerMizerLevel(PHWINFO, U032);
RM_STATUS chpCreateChipID(PCLASSOBJECT, U032, POBJECT *);
RM_STATUS chpDeleteChipID(POBJECT);
RM_STATUS mcPowerState(PHWINFO, U032, U032);
RM_STATUS mcPowerDisplayState(PHWINFO, U032, U032);
BOOL IsNV4(PHWINFO);
BOOL IsNV5(PHWINFO);
BOOL IsNV0A(PHWINFO);
BOOL IsNV10(PHWINFO);
