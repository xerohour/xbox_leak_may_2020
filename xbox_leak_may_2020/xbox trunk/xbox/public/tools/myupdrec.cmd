...
if "" == "%2" set __DEST=%_NTBINDIR%\private\ntos\recovery\cdfiles
...
if "" == "%2" set __RETAILTREE=%_NT386TREE%
if "" == "%3" set __XBETREE=%_NT386TREE%
if "" == "%4" set __X386TREE=%_NT386TREE%
if "" == "%5" set __XBINDIR=%_NTBINDIR%
if "" == "%6" set __DEST=%_NTBINDIR%\private\ntos\recovery\cdf_ext
...
if not "-e" == "%1" if not "-m" == "%1" if not exist \\xdb01\buildarchive\4039_nov01\checked\boot\XBOXROM_DVT6.BIN goto failure
if not "-e" == "%1" if not "-m" == "%1" if not exist \\xdb01\buildarchive\4039_nov01\checked\boot\XBOXROM_DVT4.BIN goto failure
if not "-e" == "%1" if not "-m" == "%1" if not exist %__X386TREE%\boot\XBOXROM_QT.BIN goto failure
if not "-e" == "%1" if not "-m" == "%1" copy /y \\xdb01\buildarchive\4039_nov01\checked\boot\XBOXROM_DVT6.BIN %__DEST%\XBOXROM.BIN
if not "-e" == "%1" if not "-m" == "%1" copy /y \\xdb01\buildarchive\4039_nov01\checked\boot\XBOXROM_DVT4.BIN %__DEST%\XBOXROM_DVT4.BIN
if not "-e" == "%1" if not "-m" == "%1" copy /y %__X386TREE%\boot\XBOXROM_QT.BIN %__DEST%\XBOXROM_QT.BIN
...
if "-m" == "%1" if not exist %__X386TREE%\boot\XBOXROM_QT.BIN goto failure
...
if "-m" == "%1" copy /y %__X386TREE%\boot\XBOXROM_QT.BIN %__DEST%\XBOXROM_QT.BIN

if "-e" == "%1" not exist \\xdb01\buildarchive\4039_nov01\checked\boot\XBOXROM_DVT6_EXT.BIN goto failure
if "-e" == "%1" not exist \\xdb01\buildarchive\4039_nov01\checked\boot\XBOXROM_DVT4_EXT.BIN goto failure
if "-e" == "%1" copy /y \\xdb01\buildarchive\4039_nov01\checked\boot\XBOXROM_DVT6_EXT.BIN %__DEST%\XBOXROM.BIN
if "-e" == "%1" copy /y \\xdb01\buildarchive\4039_nov01\checked\boot\XBOXROM_DVT4_EXT.BIN %__DEST%\XBOXROM_DVT4.BIN

if not "-m" == "%1" if not "%__RETAILTREE%" == "" if not exist \\xdb01\buildarchive\4039_nov01\retail\boot\XBOXROM_DVT6.BIN goto failure
if not "-m" == "%1" if not "%__RETAILTREE%" == "" if not exist \\xdb01\buildarchive\4039_nov01\retail\boot\XBOXROM_DVT4.BIN goto failure
if not "-e" == "%1" if not "-m" == "%1" if not "%__RETAILTREE%" == "" if not exist %__RETAILTREE%\boot\XBOXROM_QT.BIN goto failure
if not "-m" == "%1" if not "%__RETAILTREE%" == "" copy /y \\xdb01\buildarchive\4039_nov01\retail\boot\XBOXROM_DVT6.BIN %__DEST%\RETAIL\XBOXROM.BIN
if not "-m" == "%1" if not "%__RETAILTREE%" == "" copy /y \\xdb01\buildarchive\4039_nov01\retail\boot\XBOXROM_DVT4.BIN %__DEST%\RETAIL\XBOXROM_DVT4.BIN
if not "-e" == "%1" if not "-m" == "%1" if not "%__RETAILTREE%" == "" copy /y %__RETAILTREE%\boot\XBOXROM_QT.BIN %__DEST%\RETAIL\XBOXROM_QT.BIN
...
if "-m" == "%1" if not "%__RETAILTREE%" == "" if not exist %__RETAILTREE%\boot\XBOXROM_QT.BIN goto failure
...
if "-m" == "%1" if not "%__RETAILTREE%" == "" copy /y %__RETAILTREE%\boot\XBOXROM_QT.BIN %__DEST%\RETAIL\XBOXROM_QT.BIN
...
if not "-m" == "%1" if not exist \\xdb01\buildarchive\4039_nov01\checked\dump\xboxdash.xbe goto failure
if not "-m" == "%1" if not "%__RETAILTREE%" == "" if not exist \\xdb01\buildarchive\4039_nov01\retail\dump\xboxdash.xbe goto failure
if not "-m" == "%1" copy /y \\xdb01\buildarchive\4039_nov01\checked\dump\xboxdash.xbe %__DEST%\XDASH
if not "-m" == "%1" if not "%__RETAILTREE%" == "" copy /y \\xdb01\buildarchive\4039_nov01\retail\dump\xboxdash.xbe %__DEST%\RETAIL
if not "-m" == "%1" if not exist \\xdb01\buildarchive\4039_nov01\retail\xdash goto failure
if not "-m" == "%1" xcopy /y /e \\xdb01\buildarchive\4039_nov01\retail\xdash %__DEST%\XDASH\
...
:aftersamples
if not "-e" == "%1" if not exist \\xdb01\buildarchive\3944_rtm\checked\dump\dvdkey1d.bin goto failure
if not "-e" == "%1" copy /y \\xdb01\buildarchive\3944_rtm\checked\dump\dvdkey1d.bin %__DEST%\XDASH\dvdkeyd.bin
