...
sub GetArguments {
  ...
  # each flag.
  %flag_counts_possible=('a',1,'c',1,'d',3,'h',1,'i','list','m',1,'n',1,'q',1,
                         'o',1, 'p',0,'s','list','x',0, 'u','list');
  %flag_counts_actual=('a',0,'c',0,'d',0,'h',0,'i',0,'m',0,'n',0,'q',0,'o',0,
                       'p',0,'s',0,'x',0,'u',0);
...
sub GetHeader {
  ...
  push @HeadA, "CATATTR1=0x10010001:OSAttr:2:5.0";
  push @HeadA, "";
...
Usage: makelist -i lists -o outfile [-h catfile]
    ...
    -h  catfile
                ...
                included in the header of the output file
