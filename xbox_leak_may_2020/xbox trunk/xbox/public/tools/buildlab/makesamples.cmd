...
if "%TARGET%" == "" set TARGET=d:\test\XDKSamples
...
copy %COPY_PARMS% %PDRIVE%\free\dump\installer.xbe %TARGET%\default.xbe
...
if %DEBUG% == 1 echo ************************ i == %%i
xcopy %XCOPY_PARMS% %PDRIVE%\free\dump\%%i.xbe %TARGET%\Files\Samples\%%i
if errorlevel 1 (
