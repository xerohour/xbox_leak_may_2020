...
#define ACTCTX_FLAG_PROCESSORARCHITECTURE_VALID     (0x00000001)
#define ACTCTX_FLAG_LANGID_VALID                    (0x00000002)
#define ACTCTX_FLAG_ASSEMBLYDIR_VALID               (0x00000004)
...
BOOL
WINAPI
QueryActCtxAssemblyCount(
    HANDLE hActCtx,
    ULONG *lpAssemblyCount
    );

typedef enum tagACTCTX_ASSEMBLY_INFORMATION_CLASS {
    ACTCTX_ASSEMBLY_INFORMATION_CLASS_BASIC = 1,
    ACTCTX_ASSEMBLY_INFORMATION_CLASS_ASSEMBLY_NAME,
} ACTCTX_ASSEMBLY_INFORMATION_CLASS;

#define ACTCTX_ASSEMBLY_BASIC_INFORMATION_FLAG_ASSEMBLY_IS_ROOT (0x00000001)

typedef struct tagACTCTX_ASSEMBLY_BASIC_INFORMATIONA {
    DWORD dwFlags;
} ACTCTX_ASSEMBLY_BASIC_INFORMATIONA, *PACTCTX_ASSEMBLY_BASIC_INFORMATIONA;
typedef struct tagACTCTX_ASSEMBLY_BASIC_INFORMATIONW {
    DWORD dwFlags;
} ACTCTX_ASSEMBLY_BASIC_INFORMATIONW, *PACTCTX_ASSEMBLY_BASIC_INFORMATIONW;
#ifdef UNICODE
typedef ACTCTX_ASSEMBLY_BASIC_INFORMATIONW ACTCTX_ASSEMBLY_BASIC_INFORMATION;
typedef PACTCTX_ASSEMBLY_BASIC_INFORMATIONW PACTCTX_ASSEMBLY_BASIC_INFORMATION;
#else
typedef ACTCTX_ASSEMBLY_BASIC_INFORMATIONA ACTCTX_ASSEMBLY_BASIC_INFORMATION;
typedef PACTCTX_ASSEMBLY_BASIC_INFORMATIONA PACTCTX_ASSEMBLY_BASIC_INFORMATION;
#endif // UNICODE

WINBASEAPI
BOOL
WINAPI
QueryActCtxAssemblyInformationA(
    IN HANDLE hActCtx,
    IN ULONG ulAssemblyRosterIndex,
    IN ULONG cbBuffer,
    OUT PVOID lpBuffer,
    OUT ULONG *lpReturnedLength OPTIONAL
    );
WINBASEAPI
BOOL
WINAPI
QueryActCtxAssemblyInformationW(
    IN HANDLE hActCtx,
    IN ULONG ulAssemblyRosterIndex,
    IN ULONG cbBuffer,
    OUT PVOID lpBuffer,
...
#ifdef UNICODE
#define QueryActCtxAssemblyInformation  QueryActCtxAssemblyInformationW
#else
#define QueryActCtxAssemblyInformation  QueryActCtxAssemblyInformationA
#endif // !UNICODE
