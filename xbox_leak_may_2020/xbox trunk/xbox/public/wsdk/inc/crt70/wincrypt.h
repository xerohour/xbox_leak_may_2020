...
#define CERT_FIRST_RESERVED_PROP_ID         27
...
//          pvList is a LPCWSTR
//
//  In either case, only a binary CTL is supported. (ie, don't support a base64
//  encoded CTL.)
//
...
//       - There is at least one SubjectUsage (really the roots enhanced key
//         usage)
...
BOOL
WINAPI
CertInstallSignedListOfTrustedCertificates(
    IN DWORD                    dwMsgAndCertEncodingType,
    IN DWORD                    dwPurpose,
    IN DWORD                    dwFormat,
    IN const void               *pvList,
    IN DWORD                    dwFlags,
    IN void                     *pvReserved
    );

// dwPurpose values
#define CERT_INSTALL_SIGNED_LIST_PURPOSE_TRUSTED_ROOTS  1

// dwFormat values
#define CERT_INSTALL_SIGNED_LIST_FORMAT_BLOB            1
#define CERT_INSTALL_SIGNED_LIST_FORMAT_URL             2
...
//  certificate(s). Two dwFormat types are supported:
...
#define CERT_INSTALL_CA_FORMAT_BLOB                     1
#define CERT_INSTALL_CA_FORMAT_URL                      2
