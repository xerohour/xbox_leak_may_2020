...
EXTERN_C const IID IID_ITransactionLastResourceAsync;
    ...
    typedef struct ITransactionLastResourceAsyncVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *QueryInterface )( 
            ITransactionLastResourceAsync __RPC_FAR * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ void __RPC_FAR *__RPC_FAR *ppvObject);
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *DelegateCommit )( 
            ITransactionLastResourceAsync __RPC_FAR * This,
            /* [in] */ DWORD grfRM);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *ForgetRequest )( 
            ITransactionLastResourceAsync __RPC_FAR * This,
    ...
    interface ITransactionLastResourceAsync
    {
        CONST_VTBL struct ITransactionLastResourceAsyncVtbl __RPC_FAR *lpVtbl;
    };
...
EXTERN_C const IID IID_ITransactionLastEnlistmentAsync;
    ...
    typedef struct ITransactionLastEnlistmentAsyncVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *QueryInterface )( 
            ITransactionLastEnlistmentAsync __RPC_FAR * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ void __RPC_FAR *__RPC_FAR *ppvObject);
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *TransactionOutcome )( 
            ITransactionLastEnlistmentAsync __RPC_FAR * This,
            /* [in] */ XACTSTAT XactStat,
            /* [unique][in] */ BOID __RPC_FAR *pboidReason);
    ...
    interface ITransactionLastEnlistmentAsync
    {
        CONST_VTBL struct ITransactionLastEnlistmentAsyncVtbl __RPC_FAR *lpVtbl;
    };
