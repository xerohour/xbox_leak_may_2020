...
#define DIRECTINPUT_VERSION         0x070F
#endif
...
#define IDirectInputJoyConfig8_SetTypeInfo(p,a,b,c) (p)->lpVtbl->SetTypeInfo(p,a,b,c)
...
#define IDirectInputJoyConfig8_OpenConfigKey(p,a,b,c) (p)->lpVtbl->OpenConfigKey(p,a,b,c)
#else
...
#define IDirectInputJoyConfig8_SetTypeInfo(p,a,b,c) (p)->SetTypeInfo(a,b,c)
...
#define IDirectInputJoyConfig8_OpenConfigKey(p,a,b,c) (p)->OpenConfigKey(a,b,c)
#endif
