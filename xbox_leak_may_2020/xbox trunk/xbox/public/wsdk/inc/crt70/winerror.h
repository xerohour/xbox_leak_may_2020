...
//  This may be because the session is disconnected or does not currently have a user logged on. Also, you cannot control a session remotely from the system console and you cannot remote control your own current session.
//
...
//
#define ERROR_IPSEC_IKE_NEG_STATUS_END   13883L
...
//
// MessageId: CO_E_APPLICATION_DISABLED
//
// MessageText:
//
//  The application has been disabled.
//
#define CO_E_APPLICATION_DISABLED        _HRESULT_TYPEDEF_(0x80004028L)
...
// MessageText:
//
//  COM+ applications that run as a NT service may not be marked as pooled or recycled
//
