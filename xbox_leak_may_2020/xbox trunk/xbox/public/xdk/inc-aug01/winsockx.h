...
typedef struct {
    ...
    BYTE        cfgFlags;
        ...
        #define XNET_STARTUP_BYPASS_SECURITY    0x01
            ...
            // is silently ignored by xnets.lib and xnetsd.lib.
        ...
        #define XNET_STARTUP_BYPASS_DHCP        0x02
            ...
            // ignored by xnets.lib and xnetsd.lib.
    ...
    BYTE        cfgSecRegMax;
        ...
        //
        // Security associations can only be deleted by calling XNetUnregisterKey.  In
        // that case, all security associations which were explicitly or implicitly
        // created using the given XNKID will be deleted.
        //
...
#define XNET_XNADDR_RESERVED            0xFF    // No flags currently defined
...
#define XNET_GET_XNADDR_GATEWAY         0x20    // Host has an internet gateway configured
...
#define SO_ENCRYPT                      0x1010  // socket-level option to enable encryption 
